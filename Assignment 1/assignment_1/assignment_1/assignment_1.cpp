...
int main()
{
    ...
    cout << endl << "Total for Test #1 is: " <<
    totalOneTest(scores, NUM_STDS, 0) << endl;

    cout << endl << "Total for Test #5 is: " << 
    totalOneTest(scores, NUM_STDS, 4) << endl;

    cout << endl << "Total for Student #3 is: " << 
    totalOneStudent(scores, NUM_STDS, 2) << endl;

    cout << endl << "Total for Student #8 is: " << 
    totalOneStudent(scores, NUM_STDS, 7) << endl;

    cout << endl << "Average for Test #5: " <<
    averageOneTest(scores, NUM_STDS, 4) << endl;

    cout << endl << "Average for Test #8: " <<
    averageOneTest(scores, NUM_STDS, 7) << endl;

    cout << endl << "Average for Student #5: " <<
    averageOneStudent(scores, NUM_STDS, 4) << endl;

    cout << endl << "Average for Student #9: " << 
    averageOneStudent(scores, NUM_STDS, 8) << endl;

    cout << endl << "Highest test score for Student #2: " << 
    highestOneStudent(scores, NUM_STDS, 1) << endl;

    cout << endl << "The top Student: " << 
    topStudent(scores, NUM_STDS) << endl;
