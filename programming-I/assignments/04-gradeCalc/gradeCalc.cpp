...
int main() {
    ...
    if (avg >= 97 || avg == 100)     // 97% is the lowest A+ grade
        cout << "Your Grade is A+";
    else if (avg >= 94 && avg <= 96)     // 94% is the lowest A grade
        cout << "Your Grade is A";
    else if (avg >= 90 && avg <= 93)     // 90% is the lowest A- grade
        cout << "Your Grade is A-";
    else if (avg >= 87 && avg <= 89)     // 87% is the lowest B+ grade
        cout << "Your Grade is B+";
    else if (avg >= 84 && avg <= 86)     // 84% is the lowest B grade
        cout << "Your Grade is B";
    else if (avg >= 80 && avg <= 83)     // 80% is the lowest B- grade
        cout << "Your Grade is B-";
    else if (avg >= 77 && avg <= 79)     // 77% is the lowest C+ grade
        cout << "Your Grade is C+";
    else if (avg >= 74 && avg <= 76)     // 74% is the lowest C grade
        cout << "Your Grade is C";
    else if (avg >= 70 && avg <= 73)     // 70% is the lowest C- grade
        cout << "Your Grade is C-";
    else if (avg >= 60 && avg <= 69)     // 60% is the lowest D grade
        cout << "Your Grade is D";
    else
        cout << "Your Grade is F";     // 59% is the lowest F grade
